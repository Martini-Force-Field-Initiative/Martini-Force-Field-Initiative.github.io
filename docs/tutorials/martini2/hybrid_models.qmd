...
All files are provided in the tar-ball [hybrid-tutorial.tgz](http://cgmartini.nl/images/stories/tutorial/2017/hybrid-tutorial.tgz), which expands to the main directory `hybrid-tutorial/OPLS-MARTINI`. Paths will be given with respect to this directory. A directory with all the results is provided in the tar-ball [hybrid-tutorial-worked.tgz](http://cgmartini.nl/images/stories/tutorial/2017/hybrid-tutorial-worked.tgz), under `hybrid-tutorial/WORKED`.
