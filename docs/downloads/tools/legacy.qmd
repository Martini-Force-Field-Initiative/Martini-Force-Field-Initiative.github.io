...
::: callout
This version of `Martinize` is no longer maintained. For the latest version, see [[Martinize2]](./topology-structure-generation.qmd#martinize2vermouth).
:::
...
-   [triple-w.py](https://cgmartini-library.s3.ca-central-1.amazonaws.com/1_Downloads/tools/resolution_transformation/triple-w.py)
