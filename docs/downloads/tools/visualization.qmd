...
The script for use with gromacs 5 can be found here: [cg_bonds-v5.tcl](https://martiniff-library.s3.ca-central-1.amazonaws.com/1_Downloads/tools/visualization/cg_bonds-v5.tcl).

The script can be found here: [cg_bonds.tcl](https://martiniff-library.s3.ca-central-1.amazonaws.com/1_Downloads/tools/visualization/cg_bonds.tcl) (previous version: [cg_bonds.tcl.old](https://martiniff-library.s3.ca-central-1.amazonaws.com/1_Downloads/tools/visualization/cg_bonds.tcl.old)).
...
The script can be found here: [cg_secondary_structure.tcl](https://martiniff-library.s3.ca-central-1.amazonaws.com/1_Downloads/tools/visualization/cg_secondary_structure.tcl)
