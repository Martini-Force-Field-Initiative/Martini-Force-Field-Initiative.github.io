...
[Download an example of all the worked files of this module](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/legacy_material/martini2/ubiquitin.tar)
...
[Download an example of all the worked files of this module, with gromacs version 5.0.7](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/legacy_material/martini2/hiv-1_protease_gmxv5.tar)

[Download an example of all the worked files of this module with gromacs 2016.3](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/legacy_material/martini2/hiv-1_protease_gmx2016.tar)
...
<hr>
[Download an example of all the worked files of this module](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/legacy_material/martini2/kalp_gmxv5.tar)

[Download an example of all the worked files of this module using GROMACS version 2016.3](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/legacy_material/martini2/kalp_gmx2016.tar)

In the last module of this protein tutorial, we will increase the complexity of our system by embedding the protein in a lipid bilayer (the tutorial on the lipidome, lipid self-assembly and bilayer analysis can be followed [here](./lipids_and_lipidome.qmd)). We propose here to have a look at the tilt and the dimerization of KALP peptides embedded in DPPC membrane. The coarse-grained structure ([kalp.gro](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/legacy_material/martini2/kalp.gro)) and topology ([kalp.itp](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/legacy_material/martini2/kalp.itp)) of KALP can just be downloaded by clicking on the links; no need to repeat the steps to martinize the peptide. We start by solvating the protein directly with the membrane environment so that it ends up inserted. Different ways to perform this step possible; a non-exhaustive list, ordered by decreasing complexity, is presented below (note that this tutorial will focus only on the third case):
...
2. Proceed as before and start a production run. To remind you, this involves (1) editing the system.top file to reflect the version of Martini you want to use (the [KALP topology provided](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/legacy_material/martini2/kalp.itp) is version 2.1) and providing include statements for the topology files; (2) [downloading](../../../downloads/example-input-files/general-topology.qmd) or copying definitions of Martini version you want and the DPPC lipid topology file from [the lipidome](../../../downloads/force-field-parameters/martini2/lipidome.qmd); (3) using the correct names of the molecules involved; (4) downloading or copying set-up `.mdp` files for minimization, equilibration, and production runs and if necessary, editing them (bilayer simulations are best done using semi-isotropic pressure coupling and you may want to separately couple different groups to the thermostat(s)); (5) running the minimization and equilibration runs.  
...
- `martinize.py` (downloadable [here](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/legacy_material/martini2/martinize.py))
