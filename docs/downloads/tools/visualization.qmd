...
The script for use with gromacs 5 can be found here: [cg_bonds-v5.tcl](http://cgmartini.nl/images/tools/VMD/cg_bonds-v5.tcl).

The script can be found here: [cg_bonds.tcl](http://cgmartini.nl/images/tools/VMD/cg_bonds.tcl) (previous version: [cg_bonds.tcl.old](http://cgmartini.nl/images/tools/VMD/cg_bonds.tcl.old)).
...
- <strike>Not really an issue but: `cg_bonds` draws ALL bonds/constraints of the system; what if we want to</strike>[Render the secondary structure](http://cgmartini.nl/index.php/tools2/36-downloads/tools/164-rb8)<strike>and draw them only for some residues?</strike><span style="color:red">**Well... Use the good representation.**</span>
...
The script can be found here: [cg_secondary_structure.tcl](http://cgmartini.nl/images/tools/VMD/cg_secondary_structure.tcl)
