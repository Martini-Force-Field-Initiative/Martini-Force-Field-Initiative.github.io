...
You can download all the files, including worked examples of this tutorial (gromacs version 2016.3): [bilayer-lipidome-tutorial-GMX5_2017Aug04-WORKED.tgz](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/legacy_material/martini2/bilayer-lipidome-tutorial-GMX5_20170408.tar) This is a rather large archive. A smaller set that expects you to do more yourself is recommended and is named: bilayer-lipidome-tutorial-GMX5_2017Aug04.tgz Unpack one of the [lipidome-tutorial.tgz](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/legacy_material/martini2/bilayer-lipidome-tutorial-GMX5_2017Aug04.tar) archives (NOTE: both expand to a directory called `bilayer-lipidome-tutorial`), and enter the `bilayer-lipidome-tutorial` directory:
...
This section uses the backward.py tool for fine-grained-to-coarse-grained (FG-to-CG) transformation, which is treated in more detail [elsewhere](../../../downloads/tools/resolution-transformation.qmd). A related, but different strategy not using the backward.py tool is used in the [tutorial on polymers](polymers.qmd#extraction-of-properties-and-bonded-distributions-(atomistic)), advantageous there because the PEG molecule is simpler to map from FG to CG representation than lipids. 
...
- `backward.py` (downloadable [here](../../../downloads/tools/resolution-transformation.qmd))
