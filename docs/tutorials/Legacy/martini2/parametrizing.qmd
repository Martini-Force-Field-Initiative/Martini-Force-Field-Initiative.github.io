...
```
- [gromos.mdp](https://martini-library.s3.us-east-2.amazonaws.com/legacy_material/martini2/gromos.mdp)
- [gromos.gro](https://martini-library.s3.us-east-2.amazonaws.com/legacy_material/martini2/gromos.gro)
- [gromos.top](https://martini-library.s3.us-east-2.amazonaws.com/legacy_material/martini2/gromos.top)
...
```
- [mapping.ndx](https://martini-library.s3.us-east-2.amazonaws.com/legacy_material/martini2/mapping.ndx)
...
**7) Create CG simulation.** Extract one frame from your mapped trajectory and solvate it in the same solvent as the atomistic simulation. Create a top file (include the general martini itp files and the newly created molecule itp and add the right number of molecules (solute and solvent)). Create a Martini mdp file (see examples on the website). Simulate the initial form of the CG molecule (you probably will have to energy minimize and maybe relax for a few thousand steps at a smaller timestep, e.g. 5fs). [You can prepare files yourself and gather them from the Martini site, or you can download the itp files [martini_v2.0.itp](https://martini-library.s3.us-east-2.amazonaws.com/legacy_material/martini2/martini_v2.0.itp), [martini_v2.0_solvents.itp](https://martini-library.s3.us-east-2.amazonaws.com/legacy_material/martini2/martini_v2.0_solvents.itp) and [martini_toluene.itp](https://martini-library.s3.us-east-2.amazonaws.com/legacy_material/martini2/martini_toluene.itp), and take it from there.] It may be wise to create a separate directory for the CG system, for example take1.
