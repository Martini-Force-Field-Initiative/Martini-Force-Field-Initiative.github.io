...
- [Dry_Martini_v2.1](https://martiniff-library.s3.ca-central-1.amazonaws.com/1_Downloads/ff_parameters/martini2/dry_martini/Dry_Martini_v2.1_20160523.zip)  | (last modified: 23-05-2016) <br>
*[All "O"-lipids now use the 4 bead oleyl tail parameters and PO tails are in correct order.]*

- [Dry_Martini_v2.1](https://martiniff-library.s3.ca-central-1.amazonaws.com/1_Downloads/ff_parameters/martini2/dry_martini/Dry_Martini_v2.zip)  | (original release) 
