...
WARNING: THIS TUTORIAL IS DEPRECATED. SEE THE UPDATED TUTORIAL [ELSEWHEREa](../../../Martini3/ProteinsIIa/index.qmd)  [ELSEWHEREb](../../../Martini3/ProteinsIIb/index.qmd).
...
The previous command line will set up a complete system, containing a squared POPC bilayer of $7×7 nm^2$, with the KALP peptide inserted and centered in this bilayer. The whole system will be solvated in standard coarse-grained water. A small concentration of NaCl was added only to neuralize the +4 charge of KALP. More on the `insane.py` tool can be found in separate tutorials, notably setting up a complex bilayer ([lipid tutorial part II](../../../Martini3/LipidsII/index.qmd)).
