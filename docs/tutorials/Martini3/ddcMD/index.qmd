...
Note: All input data for this tutorial can be downloaded [here](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/m3_tutorials/ddcMD/ddcMD-Martini-tautorial.tar.gz). If you just landed here, we recommend you follow the [tutorials about lipid bilayers first](../tutorials.qmd).
