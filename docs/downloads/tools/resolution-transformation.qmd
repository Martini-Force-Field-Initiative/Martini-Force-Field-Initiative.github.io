...
The software can be downloaded from this [link](https://martini-library.s3.us-east-2.amazonaws.com/tools/resolution_transformation/TS2CG-master.zip), or by visiting [https://github.com/marrink-lab/TS2CG](https://github.com/marrink-lab/TS2CG).
...
[The scripts and mapping definitions for gromacs versions 4 and 5-bead oleoyl lipid chains are combined into a single zip file, which can be downloaded here.](https://martini-library.s3.us-east-2.amazonaws.com/tools/resolution_transformation/backward.zip)

[The initram.sh script for version 5 can be downloaded here.](https://martini-library.s3.us-east-2.amazonaws.com/tools/resolution_transformation/initram-v5.sh)

[The script for gromacs versions 5 and higher and the mapping files for the amino acid residues and nucleobases are combined into a single zip file, which can be downloaded here.](https://martini-library.s3.us-east-2.amazonaws.com/tools/resolution_transformation/backward-v5.zip)

### Convert Martini water to polarizable water
<hr>

- [triple-w.py](https://martini-library.s3.us-east-2.amazonaws.com/tools/resolution_transformation/triple-w.pyhttps://martini-library.s3.us-east-2.amazonaws.com/tools/resolution_transformation/triple-w.py)
...
Custom version of Gromacs to reintroduce atomistic details to CG structures [gmx_rev.tar.gz](https://martini-library.s3.us-east-2.amazonaws.com/tools/resolution_transformation/gmx_rev.tar).
