...
To get started, download the archive `titratable_martini_tutorial_files.zip` [here](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/m3_tutorials/Titratable_Martini/titratable_martini_tutorial_files.zip), which contains necessary files for this tutorial. Extract the contents of the `.zip` file in your working directory and you are ready to begin! Additionally, you can download [the worked version](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/m3_tutorials/Titratable_Martini/titratable_martini_tutorial_files_worked.zip) of this tutorial to either get some hints or to compare your results.
