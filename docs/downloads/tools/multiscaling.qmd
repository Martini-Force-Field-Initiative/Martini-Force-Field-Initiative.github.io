...
The software can be downloaded from this [link](https://cgmartini-library.s3.ca-central-1.amazonaws.com/1_Downloads/tools/resolution_transformation/TS2CG-master.zip), or by visiting <https://github.com/marrink-lab/TS2CG>.
