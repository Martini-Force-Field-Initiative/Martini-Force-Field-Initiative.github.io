...
author: "Roshan Shrestha, Riccardo Alessandri, Martin Vögele, Paulo CT Souza, Siewert-Jan Marrink, and Luca Monticelli"         # Paper authors (required)
year: "2025"           # Publication year (required)
publication: "Journal of Chemical Theory and Computation"    # Journal or similar (required)
preprint: "https://doi.org/10.26434/chemrxiv-2024-6s1wj-v3"       # URL to prepint page (optional)  
doi: "https://doi.org/10.1021/acs.jctc.5c00923"            # URL of DOI (required)  
materials: "https://pubs.acs.org/doi/suppl/10.1021/acs.jctc.5c00923/suppl_file/ct5c00923_si_001.pdf"      # URL to suplementary info (optional)
...
> Shrestha, R., Alessandri, R., Vögele, M., Hilpert, C., Souza, P. C., Marrink, S. J., & Monticelli, L. (2025). Martini 3 coarse-grained models for carbon nanomaterials. Journal of Chemical Theory and Computation, 21(18), 9035-9053.
