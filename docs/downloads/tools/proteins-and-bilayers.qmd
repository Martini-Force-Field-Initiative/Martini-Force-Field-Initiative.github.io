...
Download the script [here](https://martini-library.s3.us-east-2.amazonaws.com/tools/proteins_and_bilayers/lipid-PM-counter-fix-v3.0.py). Please note that Python 2.7 (or equivalent) is required. For help on how to use it, simply type "python lipid-PM-counter-fix-v3.0.py -h"
...
* [martinize.py](https://martini-library.s3.us-east-2.amazonaws.com/tools/proteins_and_bilayers/martinize_v_2_6.py) and python 3 version [martinize.py](https://martini-library.s3.us-east-2.amazonaws.com/tools/proteins_and_bilayers/martinize_v_2_6_py3.py) (version 2.6, May 12 2016)
...
* [martinize.py](https://martini-library.s3.us-east-2.amazonaws.com/tools/proteins_and_bilayers/martinize_v_2_5.py) (version 2.5, August 11 2015)
...
* [martinize.py](https://martini-library.s3.us-east-2.amazonaws.com/tools/proteins_and_bilayers/martinize_v_2_4.py) (version 2.4, August 18 2013)
...
* [martinize.py](https://martini-library.s3.us-east-2.amazonaws.com/tools/proteins_and_bilayers/martinize_v_2_3.py) (version 2.3, February 13 2013)
...
* [martinize.py](https://martini-library.s3.us-east-2.amazonaws.com/tools/proteins_and_bilayers/martinize_v_2_2.py) (version 2.2, November 27 2012)
...
* [martinize.py](https://martini-library.s3.us-east-2.amazonaws.com/tools/proteins_and_bilayers/martinize_v_2_0.py) (version 2.0, July 25 2012)
...
* [martinize-1.2.py](https://martini-library.s3.us-east-2.amazonaws.com/tools/proteins_and_bilayers/martinize_v_1_2.py) (version 1.2, May 22th 2012)
...
* [martinize-1.1.py](https://martini-library.s3.us-east-2.amazonaws.com/tools/proteins_and_bilayers/martinize_v_1_1.py) (version 1.1)
    - Fixed bug in pdb read-in.
    - Clean up of code.

* [martinize-1.0.py](https://martini-library.s3.us-east-2.amazonaws.com/tools/proteins_and_bilayers/martinize_v_1_0.py) (version 1.0)

### Insane
<hr>

- [insane.py](https://martini-library.s3.us-east-2.amazonaws.com/tools/proteins_and_bilayers/insane.py)
...
**Download:** [ElNeDyn-2.1.tar.gz](https://martini-library.s3.us-east-2.amazonaws.com/tools/proteins_and_bilayers/ElNeDyn-2.1.tar)
...
- [daft.tar](https://martini-library.s3.us-east-2.amazonaws.com/tools/proteins_and_bilayers/daft.tar)
...
- [seq2itp.pl](https://martini-library.s3.us-east-2.amazonaws.com/tools/proteins_and_bilayers/seq2itp.pl) (version 1.1.5)
- [martini_v2.1_example.seq](https://martini-library.s3.us-east-2.amazonaws.com/tools/proteins_and_bilayers/martini_v2.1_example.seq)
- [martini_v2.1_example.ssd](https://martini-library.s3.us-east-2.amazonaws.com/tools/proteins_and_bilayers/martini_v2.1_example.ssd)
...
- [atom2cg_v2.1.awk](https://martini-library.s3.us-east-2.amazonaws.com/tools/proteins_and_bilayers/atom2cg_v2.1.awk)

### molmaker.py: Create molecule coordinates from their .itps
<hr>

- [molmaker.py](https://martini-library.s3.us-east-2.amazonaws.com/tools/proteins_and_bilayers/molmaker.py)
