...
This tutorial is available for download [here](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/legacy_material/martini3_beta/parametrizing_new_molecule/M3tutorials--parameterizing-a-new-small-molecule.pdf). Required files and worked examples can be downloaded [here](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/legacy_material/martini3_beta/parametrizing_new_molecule/files-m3-newsm.zip), and files for Bartender can be obtained [here](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/legacy_material/martini3_beta/parametrizing_new_molecule/files-m3-bartender.zip).
...
In the following step you will need the bartender python script, and a few input fils. You can download the necessary input files [here](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/legacy_material/martini3_beta/parametrizing_new_molecule/files-m3-bartender.zip)!
