...
**The files required for this tutorial (including worked files) can be downloaded from [here](https://martini-library.s3.us-east-2.amazonaws.com/m3_tutorials/ProteinsI/M3_proteins_tutorial_part1.zip).**
...
- `create_goVirt.py` (downloadable [here](https://martini-library.s3.us-east-2.amazonaws.com/m3_tutorials/ProteinsI/create_goVirt.py))
