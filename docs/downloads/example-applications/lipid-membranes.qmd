...
Warning these bilayers were constructed using self-assembly and can therefore be slightly asymmetrical, for guaranteed symmetrical bilayers we advise using a bilayer building tool, such as [insane](../tools/topology-structure-generation.qmd#insane).
