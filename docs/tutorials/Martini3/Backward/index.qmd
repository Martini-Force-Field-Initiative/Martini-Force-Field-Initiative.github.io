...
Backmapping from Martini 3 configurations follows the same procedure described above. You only need to chage your mapping files. You can find a beta version of the Mapping files to backmap to CHARMM36 [here](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/m3_tutorials/Backward/aquaporine_backmap.zip).
