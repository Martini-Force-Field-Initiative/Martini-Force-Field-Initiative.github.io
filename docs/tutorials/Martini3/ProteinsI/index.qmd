...
**The files required for this tutorial (including worked files) can be downloaded from [here](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/m3_tutorials/ProteinsI/M3_proteins_tutorial_part1.zip).**
...
- `create_goVirt.py` (downloadable [here](https://martiniff-library.s3.ca-central-1.amazonaws.com/0_Tutorials/m3_tutorials/ProteinsI/create_goVirt.py))
