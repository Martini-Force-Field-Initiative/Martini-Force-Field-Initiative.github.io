...
[Here](https://martini-library.s3.us-east-2.amazonaws.com/tools/other_tools/morphology_suppfile.zip) an archive containing the necessary files to run a P3HT:PCBM evaporation (solvent is chlorobenzene) and to produce simulated scattering curves as described in:
...
For another example, [here](https://martini-library.s3.us-east-2.amazonaws.com/tools/other_tools/evaporation.zip) an archive containing the necessary files to run a PTEG-1:N-DMBI evaporations (the solvent is now chloroform) as described in:
...
Here you find a customized version of Gromacs with our improved angle potentials for CG simulations, together with example input files: [TORSION-WEB.zip](https://martini-library.s3.us-east-2.amazonaws.com/tools/other_tools/TORSION_WEB.zip)

Please consult the [readme-file](https://martini-library.s3.us-east-2.amazonaws.com/tools/other_tools/ReadMe.pdf) for a detailed explanation on using these potentials, and the following manuscript in which the methods have been introduced:
...
- [do-order-gmx5.py](https://martini-library.s3.us-east-2.amazonaws.com/tools/other_tools/do-order-gmx5.py)
...
- [do-order-multi.py](https://martini-library.s3.us-east-2.amazonaws.com/tools/other_tools/do-order-multi.py)
...
- [lipid-martini-itp-v05.py](https://martini-library.s3.us-east-2.amazonaws.com/tools/other_tools/lipid-martini-itp-v05.py)
- [lipid-martini-itp-v06.py](https://martini-library.s3.us-east-2.amazonaws.com/tools/other_tools/lipid-martini-itp-v06.py)

### Cross sectional area calculation
<hr>

#### <span style="color:blue"> **Usage** </span>
We propose here [a gromacs tool](https://martini-library.s3.us-east-2.amazonaws.com/tools/other_tools/cross-sectional-area.tar) that can be used to calculate the cross sectional area of membrane protein (or similar inclusion) in membrane. Schematically illustrated in the next figure:
...
The required c programs can be downloaded here: [MIA-source](https://martini-library.s3.us-east-2.amazonaws.com/tools/other_tools/MIA+Source.tar)

A description how to use the package: [MIA.pdf](https://martini-library.s3.us-east-2.amazonaws.com/tools/other_tools/mia.pdf)
...
- [pressure-tools.tar.gz](https://martini-library.s3.us-east-2.amazonaws.com/tools/other_tools/pressure-tools.tar)
...
In order to use the method you need [Gromacs/MFFA](https://martini-library.s3.us-east-2.amazonaws.com/tools/other_tools/mffa-4.0.5.tar), which is a custom version of Gromacs that supports MFFA potentials. Simple [instructions](mffa_instructions.html) and an [example](https://martini-library.s3.us-east-2.amazonaws.com/tools/other_tools/mffa-example.tar) system also available.
