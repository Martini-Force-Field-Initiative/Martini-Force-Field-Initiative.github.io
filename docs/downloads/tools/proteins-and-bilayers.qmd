...
For questions, please contact Peter Tieleman ([tieleman@ucalgary.ca](ieleman@ucalgary.ca))
...
For questions please contact Khalid Mustafin ([khalid.mustafin@phystech.edu](khalid.mustafin@phystech.edu)), Pavel Buslaev ([pbuslaev@phystech.edu](pbuslaev@phystech.edu)) or Ivan Gushchin ([ivan.gushchin@phystech.edu](ivan.gushchin@phystech.edu)).
...
Download the script [here](http://cgmartini.nl/images/lipid-PM-counter-fix-v3.0.py). Please note that Python 2.7 (or equivalent) is required. For help on how to use it, simply type "python lipid-PM-counter-fix-v3.0.py -h"
...
Martinize is a python script to generate Martini protein topology and structure files based on an atomistic structure file. It replaces the old [seq2itp](http://cgmartini.nl/index.php/tools2/36-downloads/tools/62-seq2itp), [atom2cg](http://cgmartini.nl/index.php/tools2/36-downloads/tools/107-atom2cg) and [ElNeDyn](http://cgmartini.nl/index.php/tools2/36-downloads/tools/118-end5) scripts. The produced topology and structure files are in a format suitable for Gromacs.
...
* [martinize.py](http://cgmartini.nl/images/tools/martinize/martinize-2.6/martinize.py) and python 3 version [martinize.py](http://cgmartini.nl/images/tools/martinize/python3/martinize-2.6/martinize.py) (version 2.6, May 12 2016)
...
* [martinize.py](http://cgmartini.nl/images/tools/martinize/martinize-2.5/martinize.py) (version 2.5, August 11 2015)
...
* [martinize.py](http://cgmartini.nl/images/tools/martinize/martinize-2.4/martinize.py) (version 2.4, August 18 2013)
...
* [martinize.py](http://cgmartini.nl/images/tools/martinize/martinize-2.3/martinize.py) (version 2.3, February 13 2013)
...
* [martinize.py](http://cgmartini.nl/images/tools/martinize/martinize-2.2/martinize.py) (version 2.2, November 27 2012)
...
* [martinize.py](http://cgmartini.nl/images/tool/martinize/martinize-2.1/martinize.py) (version 2.1, August 23 2012)
    - Bug fix: bond length in Martini 2.2 & 2.2p.
    - Bug fix: assignment of secondary structure.

* [martinize.py](http://cgmartini.nl/images/tools/martinize/martinize-2.0/martinize.py) (version 2.0, July 25 2012)
...
* [martinize-1.2.py](http://cgmartini.nl/images/tools/martinize/martinize-1.2.py) (version 1.2, May 22th 2012)
...
* [martinize-1.1.py](http://cgmartini.nl/images/tools/martinize/martinize-1.1.py) (version 1.1)
    - Fixed bug in pdb read-in.
    - Clean up of code.

* [martinize-1.0.py](http://cgmartini.nl/images/tools/martinize/martinize-1.0.py) (version 1.0)

### Insane
<hr>

- [insane.py](http://cgmartini.nl/images/tools/insane/insane.py)
...
In the following you'll find a tar.gz file containing the scripts and programs (listed below) that will allow you to build the topology of protein from a pdb file. The file HowTo-ElNeDyn.pdf describes the steps to follow and a tutorial ia available [here](http://cgmartini.nl/index.php/component/content/37-martini-tutorials/tutorial2/184-elastic-networks17?Itemid=350).

**Download:** [ElNeDyn-2.1.tar.gz](http://cgmartini.nl/images/tools/elnedyn/ElNeDyn-2.1.tar.gz)
...
For more information contact Xavier Periole ([x.periole@rug.nl](x.periole@rug.nl)).
...
- [daft.tgz](http://cgmartini.nl/images/tools/daft/daft.tgz)
...
A perl script to build your own peptide/protein topology (.itp). Use the -h option to see what it can do. As input it requires the amino acid sequence (.seq) and the secondary structure information (.ssd). Check out also the toy peptide example on the [application page](http://cgmartini.nl/index.php/example-applications2/35-downloads/exampleapplications?layout=blog).

- [seq2itp.pl](http://cgmartini.nl/images/tools/seq2itp/seq2itp.pl) (version 1.1.5)
- [martini_v2.1_example.seq](http://cgmartini.nl/images/tools/seq2itp/martini_v2.1_example.seq)
- [martini_v2.1_example.ssd](http://cgmartini.nl/images/tools/seq2itp/martini_v2.1_example.ssd)
...
- [atom2cg_v2.1.awk](http://cgmartini.nl/images/tools/atom2cg_v2.1.awk)

### molmaker.py: Create molecule coordinates from their .itps
<hr>

- [molmaker.py](https://raw.githubusercontent.com/mnmelo/molmaker/master/molmaker.py)
