...
We'll use the provided double membrane to create two distinct open compartments, then place different proteins in each compartment.
...
_**Figure 5: Multi-compartment double membrane system.** The double membrane creates two distinct open compartments. Ubiquitin (blue) is confined to one  compartment between the membranes (**A**), while lysozyme (green) is placed only in the other compartment (**B**)._
