...
[Here](https://martiniff-library.s3.ca-central-1.amazonaws.com/1_Downloads/tools/other_tools/morphology_suppfile.zip) an archive containing the necessary files to run a P3HT:PCBM evaporation (solvent is chlorobenzene) and to produce simulated scattering curves as described in:
...
For another example, [here](https://martiniff-library.s3.ca-central-1.amazonaws.com/1_Downloads/tools/other_tools/evaporation.zip) an archive containing the necessary files to run a PTEG-1:N-DMBI evaporations (the solvent is now chloroform) as described in:
...
Here you find a customized version of Gromacs with our improved angle potentials for CG simulations, together with example input files: [TORSION-WEB.zip](https://martiniff-library.s3.ca-central-1.amazonaws.com/1_Downloads/tools/other_tools/TORSION_WEB.zip)

Please consult the [readme-file](https://martiniff-library.s3.ca-central-1.amazonaws.com/1_Downloads/tools/other_tools/ReadMe.pdf) for a detailed explanation on using these potentials, and the following manuscript in which the methods have been introduced:
...
- [do-order-gmx5.py](https://martiniff-library.s3.ca-central-1.amazonaws.com/1_Downloads/tools/other_tools/do-order-gmx5.py)
...
- [do-order-multi.py](https://martiniff-library.s3.ca-central-1.amazonaws.com/1_Downloads/tools/other_tools/do-order-multi.py)
...
- [lipid-martini-itp-v05.py](https://martiniff-library.s3.ca-central-1.amazonaws.com/1_Downloads/tools/other_tools/lipid-martini-itp-v05.py)
- [lipid-martini-itp-v06.py](https://martiniff-library.s3.ca-central-1.amazonaws.com/1_Downloads/tools/other_tools/lipid-martini-itp-v06.py)

### Cross sectional area calculation
<hr>

#### <span style="color:blue"> **Usage** </span>
We propose here [a gromacs tool](https://martiniff-library.s3.ca-central-1.amazonaws.com/1_Downloads/tools/other_tools/cross-sectional-area.tar) that can be used to calculate the cross sectional area of membrane protein (or similar inclusion) in membrane. Schematically illustrated in the next figure:
...
The required c programs can be downloaded here: [MIA-source](https://martiniff-library.s3.ca-central-1.amazonaws.com/1_Downloads/tools/other_tools/MIA+Source.tar)

A description how to use the package: [MIA.pdf](https://martiniff-library.s3.ca-central-1.amazonaws.com/1_Downloads/tools/other_tools/mia.pdf)
...
- [pressure-tools.tar.gz](https://martiniff-library.s3.ca-central-1.amazonaws.com/1_Downloads/tools/other_tools/pressure-tools.tar)
