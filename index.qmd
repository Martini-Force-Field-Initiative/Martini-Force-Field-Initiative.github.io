...
<div id="learn-more" style="display: flex; width: 100%; height: 100vh; background: #ffffff; padding: 15px;">
  ...
  <div class="image-slider-container" style="flex: 1; display: flex; flex-direction: column; justify-content: center; padding: 20px;">
